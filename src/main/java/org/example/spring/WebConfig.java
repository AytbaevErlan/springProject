...
import org.example.spring.security.DefaultSuccessLogoutHandler;
import org.example.spring.security.DefaultUserDetailsService;

@EnableWebMvc
@EnableWebSecurity
@EnableMethodSecurity(prePostEnabled = true, securedEnabled = true)
@Configuration
@ComponentScan(basePackages = { "org.example.spring" }, excludeFilters =
        {@ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE, value = {DemoAop.class, DemoAspect.class, User.class})})
@EnableTransactionManagement
@EnableJpaRepositories("org.example.spring.persistence.repositories.springdata")
